...
protocol EditPrescriptionViewControllerDelegate{
    func noteWasSaved()
}


class EditPrescriptionViewController: UIViewController, UITextFieldDelegate {
    ...
    var delegate : EditPrescriptionViewControllerDelegate?
